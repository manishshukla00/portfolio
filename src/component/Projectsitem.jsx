...
const Projectsitem = ({img, title}) => {
  return (
    <div className='relative flex items-center justify-center h-[400px] w-full shadow-xl  shadow-gray-400 rounded-xl  group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
      <img src={img} alt="/" className='w-[100%] h-full rounded-xl group-hover:opacity-10' />
      <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        {/* React Js */}
        <a href="/">
          <p className='text-center p-3 rounded-lg bg-white text-gray-700 font-bold cursor-pointer text-lg'>Open Project</p>
        </a>
      </div>
    </div>
  )
